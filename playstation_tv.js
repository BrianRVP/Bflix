...
//Default Path when Entering a Category   page.type = 'directory'; page.contents = 'items';
...
service.create(plugin.title, plugin.id + ':start', 'Bflix®TV', true, logo);
...
//Notification
	popup.notify(' PS3™ 4K Pro and Brian Vega', 20);
  }
...
function readAndParseM3U(page, pl, m3u) {
  ...
  page.loading = true;
  if (!m3u) {
// Downloading M3U List Header

    page.metadata.title = 'Bflix®TV...';
...
//Title TopBar
  ...
  showPlaylist(page);
	...
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/Animes:Animes', "directory", {
            title: 'Animes',
			icon: 'https://dl.dropbox.com/scl/fi/oabh5arrblyk1nl2q55fy/Anim.png?rlkey=4azzmnife1c1cufr1grcfoxmf&dl=0'
        });
    }
	
	if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/Caricatura:Cartoons', "directory", {
            title: 'Caricaturas',
			icon: 'https://dl.dropbox.com/scl/fi/2rd06ifssgzq8yebs4viq/caricatura.png?rlkey=dt26r46u98rty9iwk19gjj7et&dl=0'
        });
    }
	
    if (!service.disableSampleList) {
			page.model.contents = 'grid';
		var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/Cuantas/main/Peliculas.m3u:Movies', "directory", {
            title: 'Peliculas',
			icon: 'https://dl.dropbox.com/scl/fi/rs736vadvin34wlveuzqi/pel.png?rlkey=28p9u8gfjgv588bdpsc2wlrqt&dl=0'
        });
    }

    if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/Series:Series', "directory", {
            title: 'Series',
			icon: 'https://dl.dropbox.com/scl/fi/xgqsdgykxxdz4smd0u3aa/serie.png?rlkey=ppsum3005d5fwfa4iruenso3u&dl=0'
        });
    }
	
	 if (!service.disableSampleXMLList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/Novela:Telenovelas', "directory", {
            title: 'Novelas',
			icon: 'https://dl.dropbox.com/scl/fi/hhbjxda4kue9lhoura7kb/nov.png?rlkey=he9m2vc1bpynqpethwybtjyoe&dl=0'
        });
    }

	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/lista.m3u/main/IPTV:IPTV', "directory", {
            title: 'TV',
			icon: 'https://dl.dropbox.com/scl/fi/o0ijdehio3lgq0bwvgufr/IPTV.png?rlkey=iehzu5bjn6psrouz4qjxvr6t9&dl=0'
        });
    }
	
	if (!service.disableSampleList) {
			page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/Cuantas/main/Ps3movie:Humor', "directory", {
            title: 'PS3MOVIE+',
			icon: 'https://raw.githubusercontent.com/BrianRVP/Cuantas/main/PS3MOVIE%2B.png'
        });
    }
    if (!service.disableSampleXMLList) {
	 	page.model.contents = 'grid';
        var item = page.appendItem('m3u:https://raw.githubusercontent.com/BrianRVP/Cuantas/main/Aportadores:Music', "directory", {
            title: 'APORTADORES',
			icon: 'https://dl.dropbox.com/scl/fi/a3cng443dee5yajdzvtqi/aportadors.png?rlkey=r57ifl6v3tdeugoky7lubumm2&dl=0'
        });
    }   
	
/*	if (!service.disableSampleList) {
		page.model.contents = 'grid';
       var item = page.appendItem('m3u:https://raw.github.com/LuanTeles/PlayStation-TV/main/lists/porn.m3u:Porn', "directory", {
           title: 'Porno',
			icon: 'https://raw.github.com/LuanTeles/PlayStation-TV/main/icons/porn.png'
        });
    } 
*/
	...
	if (!service.disableProviderList) {
	    ...
	    page.appendItem("", "separator", {
        title: '.::Espero Puedan Disfrutar Bflix®TV::.'
    });
});
